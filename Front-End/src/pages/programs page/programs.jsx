...
function Programs() {
  return (
    <>
      {/*First box container*/}
      <Box id= "programs" className="programs-page-container" display="flex" flexDirection= "column" gap={0}>
        
        {/*what we do container*/}
        <Box className="what-we-do-container" display="flex" flexDirection="row" justifyContent="center" alignItems="flex-start" gap={0}>
          <h2 style ={{margin: "90px 0px 60px 0"}}>Programs</h2>
        </Box>
